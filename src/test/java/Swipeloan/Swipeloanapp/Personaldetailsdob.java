...
public class Personaldetailsdob {
...
//	            selectYear("2000");
	            ...
	            public String getTextOfDay(){
	            	...
	            	WebElement day_element = driver.findElement(By.className("android.widget.SeekBar"));

	            	return day_element.getAttribute("text");

	            	}
	            
	            public void selectDay(String RequiredDay){

	            	for(int i=0; i<30; i++){

	            	ScrollDay();

	            	if(getTextOfDay().equals(RequiredDay)){
	            	break;
	            	}
...
/*	        	  driver.findElement(new AppiumBy.ByAndroidUIAutomator(
	        			    "new UiScrollable(new UiSelector().className(\"android.widget.SeekBar\")).scrollIntoView("
	        			    + "new UiSelector().className(\"android.widget.SeekBar\").instance(1))")); // Change instance as needed
*/
	        	  
/*	        	  driver.findElement(new AppiumBy.ByAndroidUIAutomator(
	        		        "new UiScrollable(new UiSelector().className(\"android.widget.SeekBar\")).scrollBackward()"));
*/	       	  
/*	        	  driver.findElement(MobileBy.AndroidUIAutomator(
	        			    "new UiSelector().className(\"android.widget.SeekBar\").description(\"2024\")"
	        			)).click();
*/
	     /*   	  working
	        	  driver.findElement(MobileBy.AndroidUIAutomator(
...
/*	         
	          public String getTextOfMonth(){
	            ...
	            public void selectMonth(String RequiredDay){

	            	for(int i=0; i<30; i++){

	            	ScrollMonth();

	            	if(getTextOfMonth().equals(RequiredDay)){
	            	break;
	            	}
	            ...
	            public void selectYear(String RequiredDay){

	            	for(int i=0; i<30; i++){

	            	ScrollYear();

	            	if(getTextOfYear().equals(RequiredDay)){
	            	break;
	            	}
	            ...
	            public void ScrollYear() {
	            	  driver.findElement(new AppiumBy.ByAndroidUIAutomator(
		        		        "new UiScrollable(new UiSelector().className(\"android.widget.SeekBar\")).scrollForward()"));  
	            }
	            */
	/*            
...
/*	
	...
	*/           
	         ...
	         // Get screen size for dynamic scrolling
	            ...
	            driver.perform(Collections.singletonList(scroll2));
