...
public class PersonalDetailsRelativeInfoTest extends BaseTest{
	...
	*/
		    ...
		    PersonalDetailsRelativeInfoPage info= new PersonalDetailsRelativeInfoPage(driver);
		    info.RelativeInfo();
