...
import pagePackage.BusinessLoanFormPage;
import pagePackage.BusinessLoanPage;
...
public class BusinessLoanFormTest extends BaseTest {
...
/*
        ...
        popUp.closePopUp();
	*/	
		BusinessLoanPage businessLoanFeature= new BusinessLoanPage(driver);
		businessLoanFeature.BusinessLoan();
		
		BusinessLoanFormPage businessForm= new BusinessLoanFormPage(driver);
