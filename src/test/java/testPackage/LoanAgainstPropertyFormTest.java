...
import pagePackage.LoanAgainstPropertyFormPage;
import pagePackage.LoanAgainstPropertyPage;
...
public class LoanAgainstPropertyFormTest extends BaseTest{
...
/*
        ...
        popUp.closePopUp();
*/		
        LoanAgainstPropertyPage lapFeature= new LoanAgainstPropertyPage(driver);
        lapFeature.LoanAgainstProperty();
        
        LoanAgainstPropertyFormPage lapForm= new LoanAgainstPropertyFormPage(driver);
        lapForm.LAPForm();
