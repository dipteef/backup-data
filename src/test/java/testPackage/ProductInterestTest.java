...
import pagePackage.ProductInterestPage;
import pagePackage.VerifiedOTPPage;
import pagePackage.VerifyOTPPage;

public class ProductInterestTest extends BaseTest{
...
/*		
		...
		panNumberField.PanNumber("AAFCC4610A");
		...
		*/
		...
		ProductInterestPage productpopup= new ProductInterestPage(driver);
		productpopup.ProductInterest();
