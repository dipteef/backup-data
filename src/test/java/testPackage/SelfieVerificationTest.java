...
import pagePackage.SelfieVerificationPage;
import pagePackage.VerifyOTPPage;

public class SelfieVerificationTest extends BaseTest{
...
//		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		...
		SelfieVerificationPage selfieVerify= new SelfieVerificationPage(driver);
		selfieVerify.SelfieFeature();
