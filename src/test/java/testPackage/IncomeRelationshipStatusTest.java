...
import pagePackage.IncomeRelationshipStatusPage;
...
public class IncomeRelationshipStatusTest extends BaseTest{
	...
	*/
		    ...
		    IncomeRelationshipStatusPage status= new IncomeRelationshipStatusPage(driver);
