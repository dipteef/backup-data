...
import pagePackage.HomesScreenExploreOffersPage;
...
public class HomeScreenExploreOffersTest extends BaseTest {
...
/*
        ...
        popUp.closePopUp();
*/		
		HomesScreenExploreOffersPage exploreOffersButton= new HomesScreenExploreOffersPage(driver);
		exploreOffersButton.ExploreOffers();
	}
}
