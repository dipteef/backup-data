...
import pagePackage.InstantFundPage;
...
public class InstaFundTest extends BaseTest {
...
*/		
		...
		InstantFundPage instantLoan= new InstantFundPage(driver);
		instantLoan.InstaFund();
