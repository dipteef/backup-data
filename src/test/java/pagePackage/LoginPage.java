...
public class LoginPage extends BaseTest {
	 ...
	 private AndroidDriver driver;
	    ...
	    private By mobileNumberField = By.xpath("//android.view.View[@content-desc=\"+91 Enter 10 Digit Mobile Number\"]/android.widget.EditText");
	    ...
	    public void enterMobileNumber(String mobileNumber) throws InterruptedException {
	        ...
	        if (editTextFields.size() >= 1) {
	            ...
	            phoneField.click();
	            phoneField.sendKeys("7757933391");
	            driver.hideKeyboard();
	/*        
	            WebElement referralCode = wait.until(ExpectedConditions.elementToBeClickable(editTextFields.get(1)));
	            referralCode.click();
	            referralCode.sendKeys("SWP");
	            driver.hideKeyboard();
*/
