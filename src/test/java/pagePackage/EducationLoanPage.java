...
public class EducationLoanPage extends BaseTest{
	
	public EducationLoanPage(AndroidDriver driver) {
		this.driver= driver;
	}
	
	String EducationLoan_xpath = "Education\nLoan";
	...
	public void EducationLoan() {
		...
		WebElement educationloan = wait.until(ExpectedConditions.elementToBeClickable(
		        new AppiumBy.ByAccessibilityId(EducationLoan_xpath)));
		educationloan.click();
