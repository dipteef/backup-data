...
public class PersonalDetailsAddressPage extends BaseTest{
	...
	String Rented_xpath = "//android.widget.ScrollView/android.widget.RadioButton[2]";
	String Owned_xpath = "//android.widget.ScrollView/android.widget.RadioButton[1]";
	...
	public void AddressDetails() throws InterruptedException {
	        ...
	        if (editTextFields.size() >= 1) {
	            ...
	            WebElement residence = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(Rented_xpath)));
	            residence.click();
