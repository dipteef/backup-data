...
public class LoanAgainstPropertyPage extends BaseTest{

	public LoanAgainstPropertyPage(AndroidDriver driver) {
		this.driver= driver;
	}
	
	String LAP_xpath = "Loan\nAgainst\nProperty";
	...
	public void LoanAgainstProperty() {
		
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20)); 

		WebElement LAP = wait.until(ExpectedConditions.elementToBeClickable(
		        new AppiumBy.ByAccessibilityId(LAP_xpath)));
		LAP.click();
