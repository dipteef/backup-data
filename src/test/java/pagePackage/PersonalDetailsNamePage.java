...
public class PersonalDetailsNamePage extends BaseTest {
	...
	String EmailList_xpath= "//android.widget.LinearLayout[@resource-id='com.google.android.gms:id/container']";
//	(//android.widget.LinearLayout[@resource-id="com.google.android.gms:id/container"])[3]/android.widget.LinearLayout
	...
	String Dob_xpath = "";
	String EditDob_xpath = "android.widget.Button";
...
//		WebElement nextButton= wait.until(ExpectedConditions.visibilityOfElementLocated(By.className(NextButton_xpath)));
 ...
 //   		WebElement date= wait.until(ExpectedConditions.elementToBeClickable(By.xpath(IncorporationDate_xpath)));
    		...
    		WebElement editDate= wait.until(ExpectedConditions.elementToBeClickable(By.className(EditDob_xpath)));
    		editDate.click();
